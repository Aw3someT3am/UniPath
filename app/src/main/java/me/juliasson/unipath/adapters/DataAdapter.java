...
import me.juliasson.unipath.model.AndroidVersion;
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> implements Filterable {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            ...
            tv_name = (TextView)view.findViewById(R.id.tvCollegeName);
            tv_version = (TextView)view.findViewById(R.id.tvEarlyActionDate);
            tv_api_level = (TextView)view.findViewById(R.id.tvRegularActionDate);
